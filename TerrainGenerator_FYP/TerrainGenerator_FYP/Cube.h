...
public:
	...
	Cube() : Primitive()
	{
		Vertex Vertices[]
		{
			...
			//Top
			glm::vec3(-0.5f, 0.5f, 0.5f),						glm::vec3(0.f,1.f,0.f),			glm::vec2(0.f, 2.f),	glm::vec3(0.f,0.f,0.f),
			glm::vec3(0.5f, 0.5f, 0.5f),						glm::vec3(0.f,1.f,0.f),			glm::vec2(2.f, 2.f),	glm::vec3(0.f,0.f,0.f),
			glm::vec3(0.5f, 0.5f, -0.5f),						glm::vec3(0.f,1.f,0.f),			glm::vec2(0.f, 2.f),	glm::vec3(0.f,0.f,0.f),
			glm::vec3(-0.5f, 0.5f, -0.5f),						glm::vec3(0.f,1.f,0.f),			glm::vec2(2.f, 2.f), 	glm::vec3(0.f,0.f,0.f),

			//Bottom
			glm::vec3(-0.5f, -0.5f, 0.5f),						glm::vec3(0.f,-1.f,0.f),		glm::vec2(0.f, 0.f),	glm::vec3(0.f,0.f,0.f),
			glm::vec3(0.5f, -0.5f, 0.5f),						glm::vec3(0.f,-1.f,0.f),		glm::vec2(2.f, 0.f),	glm::vec3(0.f,0.f,0.f),
			glm::vec3(0.5f, -0.5f, -0.5f),						glm::vec3(0.f,-1.f,0.f),		glm::vec2(0.f, 0.f),	glm::vec3(0.f,0.f,0.f),
			glm::vec3(-0.5f, -0.5f, -0.5f),						glm::vec3(0.f,-1.f,0.f),		glm::vec2(2.f, 0.f),	glm::vec3(0.f,0.f,0.f),

			//Left
			glm::vec3(-0.5f, 0.5f, 0.5f),						glm::vec3(-1.f,0.f,0.f),		glm::vec2(0.f, 2.f),	glm::vec3(0.f,0.f,0.f),
			glm::vec3(-0.5f, -0.5f, 0.5f),						glm::vec3(-1.f,0.f,0.f),		glm::vec2(0.f, 0.f),	glm::vec3(0.f,0.f,0.f),
			glm::vec3(-0.5f, -0.5f, -0.5f),						glm::vec3(-1.f,0.f,0.f),		glm::vec2(2.f, 0.f),	glm::vec3(0.f,0.f,0.f),
			glm::vec3(-0.5f, 0.5f, -0.5f),						glm::vec3(-1.f,0.f,0.f),		glm::vec2(2.f, 2.f), 	glm::vec3(0.f,0.f,0.f),
